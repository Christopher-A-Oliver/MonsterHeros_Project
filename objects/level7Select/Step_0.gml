...
if (!instance_exists(fadeIn) && selectedCancel = false && crossButtonPressed)
{
	...
	instance_change(level7BackSub,false);
}

if (!instance_exists(fadeIn) && selectedLevel7 = false && circleButtonPressed)
{
	selectedLevel7 = true;
	audio_play_sound(Select,3,false);
	instance_create_layer(x,y,"fadetransitions",fadeOut);
	fadeOut.changeToRoom = StageForest7;
	instance_change(choseLevel7Sub,false);
}