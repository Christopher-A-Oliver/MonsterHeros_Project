...
if (!instance_exists(fadeIn) && selectedCancel = false && crossButtonPressed)
{
	...
	instance_change(level4BackSub,false);
}

if (!instance_exists(fadeIn) && selectedLevel4 = false && circleButtonPressed)
{
	selectedLevel4 = true;
	audio_play_sound(Select,3,false);
	instance_create_layer(x,y,"fadetransitions",fadeOut);
	fadeOut.changeToRoom = StageForest4;
	instance_change(choseLevel4Sub,false);
}