...
if (!instance_exists(fadeIn) && selectedCancel = false && crossButtonPressed)
{
	...
	instance_change(level3BackSub,false);
}

if (!instance_exists(fadeIn) && selectedLevel3 = false && circleButtonPressed)
{
	selectedLevel3 = true;
	audio_play_sound(Select,3,false);
	instance_create_layer(x,y,"fadetransitions",fadeOut);
	fadeOut.changeToRoom = StageForest3;
	instance_change(choseLevel3Sub,false);
}