function PinkMonster_Keyboard_Profile(){
...
// ------------------ Player Keyboard Command Inputs ------------------------------
	...
	global.pinkLives -= 1;
	global.monsterHP = 1;
	audio_play_sound(pinkMonsterDieCry,3,false);
	sprite_index = Pink_Die;
	}
...
//================================Switch statement to controll the animation states==================================================
	...
	switch(sprite_index)
	{
		case Pink_Idle:			//=====================================================================================IDLE ANIMATION STATE=========================================
		...
		break;
		case Pink_Run:				//===========================================================================DASH/RUN ANIMATION STATE=========================================
		...
		break;
		case Pink_Jump:      //======================================================================JUMP ANIMATION STATE=========================================
		...
		break;
		case Pink_Atk1:					//===================================================================-ATTACK 1 ANIMATION STATE-=======================================================
		...
		if (keyAttack)
		{
			sprite_index = Pink_Atk2;
		}
		break;
		case Pink_Atk2:				//===========================================================-ATTACK 2 ANIMATION STATE-=============================================================================
